      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-8 mb-16">
        <div className="col-span-1 md:col-span-2 pr-8">
          ...
          >
            ...
            <span className="text-2xl font-playfair tracking-tight text-white">
              heylow
            </span>
          </Link>
          <p className="text-white/60 mb-6 max-w-xs text-[15px] leading-relaxed">
            A design studio crafting lightweight, low-carbon digital experiences
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-4 text-[14px] text-white/60 mb-10">
            ...
            <li>
              ...
              >
                Open Source{" "}
                <span className="px-2 py-0.5 bg-white/10 text-white text-[10px] rounded-full font-medium tracking-wide uppercase">
                  New
                </span>
              </Link>
            </li>
